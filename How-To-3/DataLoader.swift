...
protocol DataLoader {
    // All we need is for these methods to return Data or Errors once they're done.
    // These methods MUST be implemented using asynchrony, therefore all returned data will be handled in completion closures.
